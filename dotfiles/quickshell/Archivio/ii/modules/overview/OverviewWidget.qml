                ...
                delegate: RowLayout {
                    ...
                    Repeater { // Workspace repeater
                        ...
                        Rectangle { // Workspace
                            ...
                            property color defaultWorkspaceColor: Appearance.colors.colLayer3 // TODO: reconsider this color for a cleaner look
                            ...
                            StyledText {
                                anchors.centerIn: parent
                                text: workspaceValue
                                font.pixelSize: root.workspaceNumberSize * root.scale * 7
