...
def main():
    ...
    home = Path.home()
    translations_dir = Path(args.translations_dir).expanduser()
    source_dir = Path(args.source_dir).expanduser()

    if not translations_dir.is_absolute():
        translations_dir = (home / translations_dir).resolve()
    if not source_dir.is_absolute():
        source_dir = (home / source_dir).resolve()
