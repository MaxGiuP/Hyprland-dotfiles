...
Item { // Bar content region
    ...
    RowLayout { // Middle section
        ...
        width: root.barCenterSideModuleWidth

        Resources {
            alwaysShowAllResources: root.useShortenedForm === 1
    ...
    MouseArea { // Right side | scroll to change volume
        ...
        WheelHandler {
            onWheel: event => {
                ...
                const step = currentVolume < 0.2 ? 0.01 : 0.02 || 0.2;
                if (event.angleDelta.y < 0)
