                            ...
                            onActiveChanged: {
                                if (active) {
                                    ...
                                    if (root.hoveredWorkspace !== null && root.hoveredWorkspace.workspace !== windowItem.hyprlandClient.workspace.id) {
                                        HyprlandDispatch.dispatch(`movetoworkspacesilent ${root.hoveredWorkspace.workspace}, address:${windowItem.hyprlandClient.address}`);
                                    } else {
            ...
            WListView {
                ...
                delegate: TaskViewWorkspace {
                    ...
                    onClicked: {
                        ...
                        HyprlandDispatch.dispatch(`workspace ${workspaceItem.workspace}`);
                    }
                }
            }
        }
