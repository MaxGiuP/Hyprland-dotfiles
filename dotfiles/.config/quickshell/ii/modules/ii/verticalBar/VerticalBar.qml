                ...
                MouseArea  {
                    ...
                    VerticalBarContent {
                        ...
                        anchors {
                            ...
                            left: parent.left
                            right: undefined
                            leftMargin: ((Config?.options.bar.autoHide.enable && !mustShow) || launchpadOnThisScreen) ? -Appearance.sizes.verticalBarWidth : 0
                            rightMargin: 0
                        }
                        ...
                        states: State {
                            ...
                            PropertyChanges {
                                target: barContent
                                anchors.topMargin: 0
                                anchors.rightMargin: ((Config?.options.bar.autoHide.enable && !mustShow) || launchpadOnThisScreen) ? -Appearance.sizes.verticalBarWidth : 0
                            }
                        }
                    }
