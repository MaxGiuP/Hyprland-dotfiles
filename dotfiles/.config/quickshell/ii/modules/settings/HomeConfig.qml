...
ContentPage {
    ...
    // ── Search index ──────────────────────────────────────────────────────
    // Page map (after Bluetooth+Internet and Customisation+Interface were merged):
    // 0:Home  1:Connectivity  2:Peripherals  3:Display  4:Audio
    // 5:Personalisation  6:Account  7:DateTime  8:Accessibility
    // 9:Security  10:SystemInfo  11:Services  12:Hyprland
    readonly property var searchIndex: [
        // 5 · Personalisation → Customisation sub-tab
        ...
        // 5 · Personalisation → Interface & Apps sub-tab
    ...
    ContentSection {
        ...
        description: Translation.tr("Find a control without browsing every category")
