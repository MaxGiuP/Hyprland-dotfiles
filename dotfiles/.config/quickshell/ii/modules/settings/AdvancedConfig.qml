...
ContentPage {
    ...
    ContentSection {
        ...
        ConfigSwitch {
            buttonIcon: "palette"
            text: Translation.tr("GTK apps")
            checked: Config.options.appearance.wallpaperTheming.enableGtkApps
            onCheckedChanged: {
                Config.options.appearance.wallpaperTheming.enableGtkApps = checked;
            }
            StyledToolTip {
                text: Translation.tr("Shell & utilities theming must also be enabled")
            }
