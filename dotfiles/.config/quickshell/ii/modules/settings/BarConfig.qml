    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ContentSubsection {
                ...
                ConfigSelectionArray {
                    currentValue: Config.options.bar.borderless ? 1 : 0
                    onSelected: newValue => {
                        Config.options.bar.borderless = newValue === 1;
                    }
                    options: [
                        {
        ...
        ConfigRow {
            ContentSubsection {
                ...
                ConfigSelectionArray {
                    currentValue: Config.options.bar.backgroundOpacity ?? 0
                    onSelected: newValue => {
                    ...
                    options: [
                        ...
                        {
                            displayName: Translation.tr("Half"),
                            icon: "opacity",
                            value: 1
                        },
                        {
    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                checked: Config.options.bar.utilButtons.showKeyboardLayoutSwitcher
                onCheckedChanged: {
                    Config.options.bar.utilButtons.showKeyboardLayoutSwitcher = checked;
                }
                StyledToolTip {
                    text: Translation.tr("Only visible when multiple keyboard layouts are configured")
                }
            }
        }
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                text: Translation.tr("Bar hide toggle")
                checked: Config.options.bar.utilButtons.showBarHideToggle
                onCheckedChanged: {
                    Config.options.bar.utilButtons.showBarHideToggle = checked;
                }
            }
        }
    }
