    ...
    ContentSection {
        ...
        ContentSubsection {
            ...
            StyledText {
                Layout.fillWidth: true
                text: {
                    switch (Config.options.background.widgets.weather.placementStrategy) {
                    case "free":
                        return Translation.tr("Drag the weather widget directly on the desktop, or adjust its coordinates below.");
                    case "leastBusy":
                        return Translation.tr("Automatically places the weather widget in the least busy wallpaper region.");
                    case "mostBusy":
                        return Translation.tr("Automatically places the weather widget in the busiest wallpaper region.");
                    default:
                        return "";
                    }
                }
            ...
            ConfigRow {
                visible: Config.options.background.widgets.weather.placementStrategy === "free"
                uniform: true
