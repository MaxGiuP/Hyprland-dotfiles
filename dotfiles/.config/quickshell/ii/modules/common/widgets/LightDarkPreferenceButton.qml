    ...
    contentItem: Item {
        ...
        ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            MaterialSymbol {
                                ...
                                text: "check"
                                iconSize: 20
                                color: lightDarkButtonRoot.toggled ? lightDarkButtonRoot.colForegroundToggled : lightDarkButtonRoot.previewBg
                            }
                        }
                        Rectangle {
                            radius: Appearance.rounding.unsharpenmore
            ...
            StyledText {
                ...
                color: lightDarkButtonRoot.toggled ? lightDarkButtonRoot.colForegroundToggled : Appearance.colors.colOnLayer2
                horizontalAlignment: Text.AlignHCenter
            }
        }
    }
