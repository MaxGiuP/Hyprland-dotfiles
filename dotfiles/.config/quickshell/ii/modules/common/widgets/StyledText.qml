...
Text {
    ...
    property bool useDefaultVariableAxes: true
    ...
    font {
        ...
        variableAxes: (shouldUseNumberFont || !root.useDefaultVariableAxes || Appearance.disableVariableFonts) ? ({}) : Appearance.font.variableAxes.main
    }
