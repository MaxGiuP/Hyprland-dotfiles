                ...
                Item {
                    ...
                    StyledFlickable { // Notification actions
                        ...
                        RowLayout {
                            ...
                            property int utilityButtonCount: openAppButton.visible ? 3 : 2
                            ...
                            NotificationActionButton {
                                ...
                                implicitWidth: (notificationObject.actions.length == 0)
                                    ? ((actionsFlickable.width - (actionRowLayout.spacing * (actionRowLayout.utilityButtonCount - 1))) / actionRowLayout.utilityButtonCount)
