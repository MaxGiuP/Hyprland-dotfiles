...
Singleton {
    ...
    ColorQuantizer {
        ...
        source: (Config?.options.appearance.transparency.enable && Config?.options.appearance.transparency.automatic)
    ...
    colors: QtObject {
        ...
        property color colOnPrimary: ColorUtils.bestTextColor(colors.colPrimary)
        ...
        property color colOnPrimaryContainer: ColorUtils.bestTextColor(colors.colPrimaryContainer)
        // Secondary
