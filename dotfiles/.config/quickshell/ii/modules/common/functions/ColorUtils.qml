...
Singleton {
    ...
    /**
     * Converts an sRGB channel to a linear-light value.
     *
     * @param {number} channel - The sRGB channel value in the range [0, 1].
    ...
    /**
     * Computes the WCAG relative luminance for a color.
     *
    ...
    /**
     * Picks whichever text color has better contrast on the given background.
     *
     * @param {string} background - The background color.
     * @param {string} lightText - Optional light foreground candidate.
     * @param {string} darkText - Optional dark foreground candidate.
     * @returns {string} The more legible text color.
     */
    function bestTextColor(background, lightText = "#FFFFFF", darkText = "#111111") {
